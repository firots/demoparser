...
pub static CUSTOM_PLAYER_PROP_IDS: phf::Map<&'static str, u32> = phf_map! {
    ...
    "spotted_by_mask_raw" => SPOTTED_BY_MASK_RAW_ID,
    "spotted_by_mask_exact_ids" => SPOTTED_BY_MASK_EXACT_IDS_ID,
...
pub static TYPEHM: phf::Map<&'static str, PropType> = phf_map! {
    ...
    "spotted_by_mask_raw" => PropType::Custom,
    "spotted_by_mask_exact_ids" => PropType::Custom,
